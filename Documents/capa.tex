\begin{titlepage}					% Inicia capa
	...
	\begin{center}
		...
		% Título
		\textsc{\LARGE \bfseries E02 -- Medida de Defasagem entre Duas Ondas}\\

		\sectionline

		\begin{flushleft}
			\emph{\textbf{Autores:}} Gael Vinícius Maia Sampaio, Jônatas Augusto de Paula, José Guilherme Correia de Menezes  \\
